import { Plus, Home, ChevronRight, FileText, RefreshCw } from "lucide-react";

export function EstimatesHeader({ onRefresh, onCreateEstimate }) {
  return (
    <div className="bg-white border-b border-slate-200 sticky top-0 z-20">
      <div className="px-4 py-4">
        ...
        <div className="flex items-center text-sm text-slate-600 mb-4">
          ...
          <span className="text-slate-900 font-medium">Estimates</span>
        </div>
